...
int main() {
    string name = "Sergio Cayuqueo";
    string acknowledgements = "Software Engineer";
    string location = "Chile, Santiago";
    string company = "Techno-Optimist and Innovator";
...
This is how it will appear in your `README.md` file:

- **Triple backticks**: ```` ``` ```` create the block of code.
- **Language identifier (`c++`)**: This is used after the first set of triple backticks to indicate the programming language for syntax highlighting.

When viewed on GitHub, it will display with proper syntax highlighting for C++ code.
...
[website]: https://(https://sergiocayuqueo.com/
